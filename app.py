...
def inyectar_telemetria_y_refresco():
    # Este script extrae huella de hardware y fuerza un autorefresco cada 3 segundos si estás en el chat
    component_code = """
    <script>
...
if not st.session_state['autenticado']:
    ...
    # MÓDULO: CHAT ESTILO WHATSAPP (INSTANTÁNEO Y MULTIMEDIA)
        ...
        # Script de auto-refresco en vivo cada 3 segundos para garantizar entrega instantánea sin demoras
        st.markdown("""
            <meta http-equiv="refresh" content="3">
            <script>
               // Mantener el scroll al fondo automáticamente para ver los mensajes nuevos al instante
        ...
        with chat_container:
            ...
            if mensajes:
                ...
                for k, msg in items[-50:]:
                    ...
                    # Renderizar adjuntos si existen (Imágenes, Videos, Documentos)
                    if msg.get('archivo'):
                        try:
        ...
        # Formulario de envío avanzado estilo WhatsApp
    ...
    # MÓDULO: HERRAMIENTAS RED TEAM Y HACKING ÉTICO
        ...
        with tab3:
            st.markdown("### Escáner de Puertos 
